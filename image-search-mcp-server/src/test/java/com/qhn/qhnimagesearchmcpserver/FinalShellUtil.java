package com.qhn.qhnimagesearchmcpserver;
...
public class FinalShellUtil {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("版本号 (4.5)");
        try {
            System.out.println("高级版: " + keccak384(code + "wcegS3gzA$").substring(12, 28));
            System.out.println("专业版: " + keccak384(code + "b(xxkHn%z);x").substring(12, 28));
        } catch (NoSuchAlgorithmException e) {
            e.printStackTrace();
        }
    }
