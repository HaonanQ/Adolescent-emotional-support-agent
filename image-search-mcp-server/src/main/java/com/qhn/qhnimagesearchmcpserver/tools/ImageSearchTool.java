package com.qhn.qhnimagesearchmcpserver.tools;
...
public class ImageSearchTool {
    ...
    private static final String API_KEY = "09oVHr3Mep7fuEMGXQhUEnwQlGtUpXw6ewYG32niemBe2qd0N8bVcmKF";
     ...
     */
    @Tool(description = "搜索青少年情侣头像图片，风格可选：可爱、浪漫、简约、动漫、写实等")
     ...
     * @return 图片 URL 列表（逗号分隔）
     */
    @Tool(description = "搜索浪漫温馨背景图，主题可选：星空、樱花、海边、日落、雪山、花海等，用于青少年在经历一些挫折时给予安慰和鼓励的图片。")
    ...
    public String searchGiftIdea(
            @ToolParam(description = "接收者：me(自己) 或 boyfriend(男友) 或 girlfriend(女友)") String recipient,
            @ToolParam(description = "场合：生日、纪念日、情人节、圣诞节等") String occasion
    ) {
        String recipientStr = recipient.equals("me") ? "myself" : "girlfriend or boyfriend";
     ...
     * @return 图片 URL 列表（逗号分隔）
     */
    @Tool(description = "搜索出门放松地点参考图，地点类型可选：餐厅、咖啡厅、公园、海边、游乐园、美术馆等")
