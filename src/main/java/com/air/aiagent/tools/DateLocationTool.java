...
public class DateLocationTool {
     ...
     * @return 路线规划结果
     */
    @Tool(description = "规划释放压力出去散心的路线，可指定交通方式。交通方式可选：driving(驾车)、walking(步行)、transit(公交/地铁)、bicycling(骑行)")
     ...
     * @return 地点列表
     */
    @Tool(description = "搜索适合放松游玩的地点，如餐厅、咖啡厅、电影院、公园等。地点类型可选：restaurant(餐厅)、cafe(咖啡厅)、cinema(电影院)、park(公园)、mall(商场)")
     ...
     * @return 距离信息
     */
    @Tool(description = "获取两个地点之间的距离，帮助规划行程时间")
